    ...
    <div className="frame">
      <div className="frame-amount frame-wrapper">
        <div className="div">
          <div className="div-2">
            <div className="div-3">
              <div className="text-wrapper text-black-12">Amount Pending</div>
              <svg
                width="17"
                height="16"
                viewBox="0 0 17 16"
          ...
          <div className="div-2">
            <div className="text-wrapper-2 text-black-30">₹92,312.20</div>
            <div className="div-4">
              <div className="link">
                <a className="link-2 text-primary-blue">13 orders</a>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
