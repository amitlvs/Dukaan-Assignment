...
const AmountProcessingCard = () => {
  return (
    <div className="frame">
      <div className="frame-amount frame-wrapper">
        <div className="div">
          <div className="div-2">
            <div className="div-3">
              <div className="text-wrapper text-black-12">Amount Processed</div>
              <svg
                width="17"
                height="16"
                viewBox="0 0 17 16"
          ...
          <div className="div-2">
            <div className="text-wrapper-2 text-black-30">₹23,92,312.19</div>
          </div>
        </div>
      </div>
    </div>
...
export default AmountProcessingCard;
